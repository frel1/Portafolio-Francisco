...
const title = 'Francisco Elías';
const descripcion = "Estudiante de la Técnicatura Universitaria en Programación - UTN";
const residencia = 'Pergamino, Buenos Aires, Argentina';
const presentacion = "Bienvenido a mi portafolio de proyectos";
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/Francisco-Elias/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/Franciscoelias/' },
  { id: 3, name: 'github', src: github, url: '' },
  { id: 4, name: 'curriculum', src: cv, url: '' },
];
const telefono = '+54 9 2477456789';
</script>
