...
import proyecto2 from '/src/assets/ecom.png';
...
misProyectos.value = ([
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Plataforma de E-Commerce (2022)",
        descripcion: "Participé en el diseño y desarrollo de una aplicación destinada al E-Commerce dentro del territorio nacional.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
])
...
.proyecto-info p {
    ...
    font-size: 1em;
    color: #666;
    flex-grow: 1; /* Ocupa el espacio sobrante para empujar los botones al fondo */
}
...
.proyecto-links {
    ...
    flex-direction: column;
    gap: 10px;
    margin-top: auto; /* Empuja los botones hacia el fondo */
}
